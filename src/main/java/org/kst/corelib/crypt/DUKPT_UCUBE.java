...
public class DUKPT_UCUBE {
    ...
    public static String decrypt(String ksn, String bdk, String data) throws Exception {
        ...
        return HexUtils.xor(decrypted.substring(0, 16), IV)+decrypted.substring(16);
    }
	...
	public static void main(String[] args) {
		...
		final String KSN = "270000F15CAD88000011";
		final String BDK = "BC744EDCE086E71A515B119C8198C4D4";//"BC744EDCE086E71A515B119C8198C4D4";
		final String ENC_DATA = "7FCD8B84F4436F99A106A4604FB41F6942D9AB6E0C2586F4";
