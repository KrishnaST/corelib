...
public class EMV {
	...
	private static final String HSM_COMMAND = "KW";
	private static final String MODE = "1";
	private static final String SCHEME_ID = "2";	
	private static final String IMK = "U6C58184333A1628A1EF4F0C3B9C41D37";
	...
	public static String generateARPC(final String PAN, String DE55)
	{
		...
		try {
			...
			String header = HSM_COMMAND+MODE+SCHEME_ID+IMK;
			...
			header = ByteUtils.byteArrayToHexString(Integer.toHexString(len).getBytes())+header;
